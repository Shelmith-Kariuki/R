...
#### Generate a function that will plot a time series graph for each time series variable
...
#### Generate a function that will plot a time series graph for each time series variable, grouped by type of bank account, and loan term 
