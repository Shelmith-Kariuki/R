...
df1 <- df %>% 
  select(contains("e")) ## Picking variables that contains letter e.
...
filter works with mathematical opperations.
...
In english grammar, filter means removing unwanted material. But in R, we mostly use filter to keep observations, depending on the mathematical operations used.
