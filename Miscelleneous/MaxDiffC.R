...
## Most Desirable
vars1 <- c("SurveyId", "C1", "C2","C3","C4","C5","C6","C7")
...
## Least Desirable
vars2 <- c("SurveyId","C1_1", "C2_1",  "C3_1", "C4_1","C5_1","C6_1","C7_1")
...
alternativeNames <- unique(gsub("B1|B2|B3|B4|B5|B6|B7|_|_1","",names(MBS)))
